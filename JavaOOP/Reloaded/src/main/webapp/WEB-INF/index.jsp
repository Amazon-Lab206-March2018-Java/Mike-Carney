...
<body>
	<table>
		...
		<tr>
			<td><a href="/languages/<c:out value="${language.getId()}"/>"><c:out value="${language.getName()}"/></a></td>
			<td><c:out value="${language.creator}"/></td>
			<td><c:out value="${language.version}"/></td>
			<td><a href="/languages/edit/<c:out value="${language.getId()}"/>">Edit</a><a href="/languages/delete/<c:out value="${language.getId()}"/>">Delete</a></td>
		</tr>
		</c:forEach>
	</table>
