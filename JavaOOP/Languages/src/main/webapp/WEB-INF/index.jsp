...
<body>
	<table>
		...
		<tr>
			<td><a href="/languages/<c:out value="${languages.indexOf(language)}"/>"><c:out value="${language.getName()}"/></a></td>
			<td><c:out value="${language.creator}"/></td>
			<td><c:out value="${language.version}"/></td>
			<td><a href="/languages/edit/<c:out value="${languages.indexOf(language)}"/>">Edit </a>
				<a href="/languages/delete/<c:out value="${languages.indexOf(language)}"/>"> Delete</a>
			</td>
		</tr>
		</c:forEach>
	</table>
